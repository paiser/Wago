...
static const char *RcsId = "$Id: Wago.cpp,v 1.16 2013-09-04 16:32:50 kowalisz Exp $";
//=============================================================================
//
// file :        Wago.cpp
//
...
void Wago::init_device()
{
	...
	//logInst = new Tango::LogAdapter(this); //(setup logging for underlying layer. TODO this should be in constructor ( issue :pogo generates destructor without protected region )
...
void Wago::add_dynamic_attributes()
{
	...
	for(unsigned int i =0; ld = wd->GetLd(i);i++)
	{
		...
		INFO_STREAM << "Wago::add_dynamic_attributes() dev: " << this->device_name << "  attr: "  << ld->GetName() << endl;
